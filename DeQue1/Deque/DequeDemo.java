...
// ArrayDeque and LinkedList are the two main implementations of the Deque interface in Java
...
public class DequeDemo {
    public static void main(String[] args) {
        ...
        Deque<Integer> deque1 = new ArrayDeque<>(); // faster iteration because serial-wise indexed based operation, low memory, no null allowed
        ...
        Deque<Integer> deque2 = new LinkedList<>(); // you can use linkedlist in  insertion, deletion somewhere in middle
